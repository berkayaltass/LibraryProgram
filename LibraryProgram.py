...
while True:
    print("(1) Kütüphaneye Üye Ekle")
    print("(2) Kütüphaneden Üye Çıkar")
    print("(3) Kitap Ekle" )
    print("(4) Kitap Çıkar")
    print("(5) Kitap Alacak Üye Ekle")
    print("(6) Kitap Bırakacak Üye Çıkar")
    print("(7) Kitap Ara")
    print("(8) Üye Ara\n")

    islem_giris=input("Yapmak istediğiniz işlem numarasını giriniz : ")
   
    if int(islem_giris) > 8 :
        print("\n***Yanlış tuşlama yaptınız. Tekrar deneyiniz.***\n")
    else : 
